...
#LAYER OF FULL CONNECTION PARAMS
FC_SIZE = 512
...
def inference(input_tensor, train, regularizer):
    with tf.variable_scope('layer1-conv1'):
        ...
        #<padding> IS "SAME": USE 0 TO FILL; <padding> IS "VALID": DO NOT USE 0 TO FILL, KEEP ORIGIONAL
    ...
    with tf.variable_scope('layer5-fc1'):
        ...
        fc1 = tf.nn.dropout(fc1, 0.5) if train else fc1
